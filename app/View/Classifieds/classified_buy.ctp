...
<a href='classified_buy' class="btn red " role="button" rel='tab' id="cla_buy">Buy</a> 
<a href='classified_sel' class="btn blue" rel='tab' role="button" id="cla_sel">Sell</a></div>
<?php
$c=0;
...
function view_classified(id){
	$(document).ready(function() {
		...
		$.ajax({
			url: "<?php echo $webroot_path; ?>Classifieds/view_ad_buy/"+id,
