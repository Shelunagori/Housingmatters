...
<div class="controls">
&nbsp;&nbsp;<input type="text" name="amount1" id="amtttt" class="m-wrap span5" maxlength="10" style="text-align:right;"/>
...
<?php	  
        ...
        <div class="controls">
        &nbsp;&nbsp;<input type="text" name="amount1" class="m-wrap span5" id="amt_other" maxlength="10" style="text-align:right;"/>
		<a href="#myModal2" role="button" class="btn btn-danger" data-toggle="modal">Bill Detail</a> 
...
<?php		
			...
			<div class="controls">
			&nbsp;&nbsp;<input type="text" name="amount2" class="m-wrap span5" id="amt_other2" maxlength="10" style="text-align:right;"/>  
