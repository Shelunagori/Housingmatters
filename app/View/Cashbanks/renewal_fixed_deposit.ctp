...
{
$transaction_idd = (int)$data['fix_deposit']['transaction_id'];
...
<label style="font-size:14px;"><b>Branch</b> : <?php echo $branch; ?></label>
<br />

<label style="font-size:14px;"><b>Account Reference</b> : <?php echo $reference; ?></label>
<br />
<br />
<label style="font-size:14px;">Principal Amount</label>
<div class="controls">
<input type="text" class="m-wrap span7" style="text-align:right;" maxlength="10" id="amttt2" value="<?php echo $amt; ?>" name="amount">
...
<div class="controls">
<input type="text" class="date-picker m-wrap span7" data-date-format="dd-mm-yyyy" name="maturity_date" id="mttdatt">
