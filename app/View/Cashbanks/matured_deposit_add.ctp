...
<a href="<?php echo $webroot_path; ?>Cashbanks/fixed_deposit_bar_chart" class="btn" rel='tab'>Bar Chart</a>
<a href="<?php echo $webroot_path; ?>Cashbanks/matured_deposit_add" class="btn yellow" rel='tab'>Approve matured Deposit</a>
</center>
</div>
<?php ///////////////////////////////////////////////////////////////////////////////////////////////////////// ?>
<?php
...
$("#result").html('<div align="center" style="padding:10px;"><img src="as/loding.gif" />Loading....</div>').load("matured_deposit_approve_ajax?date1=" +date1+ "&date2=" +date2+ "");
});
});
</script>