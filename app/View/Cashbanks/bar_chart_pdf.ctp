...
<div style="width:6.3%; height:350px; float:left;">
 ...
 <div style="width:100%; height:20%;">
    <p style="text-align:right;"><b><?php echo $total_amt2 = round($total_amt); ?></b></p>
     ...
     <div style="width:100%; height:20%;">
     <p style="text-align:right;"><b><?php echo $subtotal*3; ?></b></p>
     
    </div>  
    
     <div style="width:100%; height:20%;">
     <p style="text-align:right;"><b><?php echo $subtotal*2; ?></b></p>
    </div>  
    
     <div style="width:100%; height:20%;">
   <p style="text-align:right;"><b><?php echo $subtotal*1; ?></b></p>
     </div>  
