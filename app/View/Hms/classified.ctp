...
<a style="margin-bottom:4px;" href="classified" <?php if(empty($cat)) { ?>class="btn green" <?php } if(!empty($cat)) {?>class="btn" <?php } ?>>All</a>
<?php
...
?>
<a style="margin-bottom:4px;" href="classified?cat=<?php echo $category_id; ?>" <?php if($cat!=$category_id) { ?> class="btn" <?php } ?> <?php if($cat==$category_id) { ?>class="btn green"<?php } ?>><?php echo $category_name; ?></a>
<?php } ?>
</div>
...
<div style="padding:10px;" >
<div class="perple">
<table  width="100%" style="background-color:#F4F4F4; border:solid 3px #1d943b !important;" cellpadding="2px;" cellspacing="2px;">
<tr>
<td width="30%" rowspan="9" valign="top"><img src="<?php echo $this->webroot ; ?>/classified_photos/<?php echo $path; ?>" style="height:150px; width:100%;"></td>
...
<tr>
<td><b>User Name/Flat:</b> <?php echo $user_name; ?> (<?php echo $wing_flat; ?>)</td>
</tr>
<tr>
...
<tr>
<td align="right"><a href="classified_detail?con=<?php echo $auto_id; ?>" class="btn mini"  style="border:solid 2px #999;" >View Detail</a></td>
</tr>
</table>
</div>
</div>
