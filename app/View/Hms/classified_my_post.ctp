            ...
            <a href="classified_my_post" class="btn green"><b>My Post</b></a>
            ...
            <a href="classified.php" <?php if(empty($cat)) { ?>class="btn green" <?php } if(!empty($cat)) {?>class="btn" <?php } ?>>All</a>
			<?php
			foreach ($result_classified_my_post as $collection)
			{
			...
			?>
			<a href="classified.php?cat=<?php echo $category_id; ?>" <?php if($cat!=$category_id) { ?> class="btn" <?php } ?> <?php if($cat==$category_id) { ?>class="btn green"<?php } ?>><?php echo $category_name; ?></a>
			<?php } ?>
            </div> --> 
       ...
       foreach ($resut_cat as $collection)
		...
		?>
            ...
            <tr>
   			<td align="right"><a href="classified_detail_mypost?con=<?php echo $auto_id; ?>" class="btn mini"  style="border:solid 2px #999;" >View Detail</a></td>
  			</tr>
            </table>
			</div>
            </div>
