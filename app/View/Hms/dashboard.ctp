			...
			<table class="table shadow table-bordered table-advance table-hover">
				<thead>
					<tr >
						...
						<a href="<?php echo $this->webroot ; ?>Documents/index" rel='tab' class="pull-right" style="font-size: 12px;" ><i class="icon-search" style="text-decoration: none;font-size: 14px;"></i></a>
						<?php 
				...
				<tbody>
					...
					?>
					<tr>
						<td><a href="<?php echo $this->webroot ; ?>Documents/index" rel='tab'> <?php echo $resource_title_cut; ?> </a></td>
					</tr>
					<?php } 
