...
if (typeof val != "undefined")
{
	$("#btn"+p_id).remove();
	//alert(val);
	$( "#poll"+p_id).html('Saving Vote...').load( 'poll_save_vote?poll_id=' + p_id + '&c_id=' + val +'&type=' + type, function() {
		$( "#poll"+p_id).load( 'poll_result_after_vote?poll_id=' + p_id + '&c_id=' + val +'&type=' + type);
	});
}
...
//alert(p_id);
	var allVals = [];
	 ...
	 $("#btn"+p_id).remove();
		...
		var q=allVals.join(',')
		$( "#poll"+p_id).load( 'poll_save_vote?poll_id=' + p_id + '&c_id=' + q +'&type=' + type, function() {
			$( "#poll"+p_id).load( 'poll_result_after_vote?poll_id=' + p_id + '&c_id=' + q +'&type=' + type);
