...
$(document).ready(function() {
	 $(".edit_poll").live('click',function(){
		...
		$("#poll_edit_content").html('<div align="center" style="padding:20px;"><img src="<?php echo $this->webroot ; ?>/as/indicator_blue_small.gif" /><br/><h5>Please Wait</h5></div>').load('poll_edit?p_id='+p_id+'&edit=0');
	 });
	 ...
	 $(".save_edited_poll").live('click',function(){
		...
		$("#poll_edit_content").load('poll_edit?p_id='+p_id+'&des='+des+'&c_date='+close_date+'&edit=1', function() {
	 ...
	 $(".delete_poll").live('click',function(){
		...
		$("#poll_edit_content").html('<div align="center" style="padding:20px;"><img src="<?php echo $this->webroot ; ?>/as/indicator_blue_small.gif" /><br/><h5>Please Wait</h5></div>').load('poll_delete?p_id='+p_id+'&delete=0');
	 });
	 
	 $(".delete_poll_btn").live('click',function(){
	 
		var p_id=$(this).attr("poll_id");
		$("#poll_edit_content").load('poll_delete?p_id='+p_id+'&delete=1', function() {
			$("#poll"+p_id).remove();
		});
