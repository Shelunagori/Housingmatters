...
?>
<a href="<?php echo $url; ?>" rel='tab' style="text-decoration:none;"><div class="ntfction_list"><?php echo $icon; ?> <?php echo $text; ?> <?php echo @$user_name; ?> <?php echo $flat_info; ?>.  <span style="color:#C0C7CC;"><?php echo $before_days; ?></span></div></a>
<?php } ?>
