 ...
 <br>             
           ...
           <div class="hide_at_print">            
			<?php
             ...
             {
             ?>              
            <a href="bank_receipt" class="btn blue">Create</a>
            <a href="bank_receipt_view" class="btn red">View</a>
            <?php } ?>
...
$(document).ready(function() {
	$("#go").live('click',function(){
		...
		{
		$("#result").html('<div align="center" style="padding:10px;"><img src="as/loding.gif" />Loading....</div>').load("bank_receipt_show_ajax?date1=" +date1+ "&date2=" +date2+ "");
		}
