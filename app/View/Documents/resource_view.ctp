		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				...
				<td valign="top">
					...
					<a href="<?php echo $webroot_path; ?>resource_file/<?php echo $name; ?>" download><i class="icon-download-alt"></i> Download</a> <?php if($role_id==3) {?>  | <a href="<?php echo $webroot_path; ?>/Documents/resource_edit/<?php echo $id ?>" rel='tab' role="button"> <i class=" icon-edit"></i> Edit</a> <?php } ?>
				</td>
			</tr>
		</table>
	</div>
